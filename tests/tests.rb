...
describe RosetteAPI do
  ...
  describe '.get_language' do
    request_file = File.open('../mock-data/request/language.json')
    before do
  ...
  describe '.get_morphology_complete' do
    request_file = File.open('../mock-data/request/morphology_complete.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_compound_components' do
    request_file = File.open('../mock-data/request/morphology_compound_components.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_han_readings' do
    request_file = File.open('../mock-data/request/morphology_han_readings.json', :encoding => 'utf-8')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_parts_of_speech' do
    request_file = File.open('../mock-data/request/morphology_parts_of_speech.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_lemmas' do
    request_file = File.open('../mock-data/request/morphology_lemmas.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_entities' do
    request_file = File.open('../mock-data/request/entities.json', :encoding => 'utf-8')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_entities_linked' do
    request_file = File.open('../mock-data/request/entities_linked.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_categories' do
    request_file = File.open('../mock-data/request/categories.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_relationships' do
    request_file = File.open('../mock-data/request/relationships.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.name_translation' do
    request_file = File.open('../mock-data/request/name_translation.json', :encoding => 'utf-8')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
    ...
    it 'badRequestFormat: needs to provide name parameter' do
      params = Parameters.new
      params.target_language = 'eng'
      params.target_script = 'Latn'
  ...
  describe '.name_similarity' do
    request_file = File.open('../mock-data/request/name_similarity.json', :encoding => 'utf-8')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_tokens' do
    request_file = File.open('../mock-data/request/tokens.json', :encoding => 'utf-8')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
  ...
  describe '.get_sentences' do
    request_file = File.open('../mock-data/request/sentences.json')
    before do
      stub_request(:post, 'https://api.rosette.com/rest/v1/info?clientVersion=1.0.2').
          with(:body => "\"{\\\"body\\\": \\\"version check\\\"}\"",
               :headers => {'Accept' => 'application/json',
